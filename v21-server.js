...
// Mantém toda a base V20 intacta e injeta a V21 imediatamente antes
...
if (!wrapperSource.includes(marker)) {
  throw new Error('V21 não encontrou o ponto seguro de extensão da base V20.');
}
...
const runtimeFilename = path.join(__dirname, 'presence-lite-server.v21-wrapper.runtime.js');
