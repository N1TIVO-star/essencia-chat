...
// Mantém toda a base funcional e aplica as camadas incrementais antes
...
if (!wrapperSource.includes(marker)) {
  throw new Error('V25 não encontrou o ponto seguro de extensão da base.');
}
...
const runtimeFilename = path.join(__dirname, 'server.presence-lite.v25-wrapper.runtime.js');
